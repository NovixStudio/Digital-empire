...
const WEBSITE_TYPES = [
  ...
  {id:'news',    name:'Новостной портал',     nameEn:'News portal',           icon:'🗞️', baseCost:1050,    baseIncome:6,    unlockNetWorth:900,     category:'content'},
  {id:'shop',    name:'Интернет-магазин',     nameEn:'Online store',          icon:'🛒', baseCost:1650,    baseIncome:10,   unlockNetWorth:1600,    category:'commerce'},
...
function tick(){
  ...
  if(state.secondsElapsed >= GAME_DAY_SECONDS){
    ...
    if(activeScreen==='dash'){ renderFinanceCard(); renderTaxCard(); renderPayrollCard(); renderHostingCard(); }
    refreshTaxModal();
    refreshPayrollModal();
    refreshHostingModal();
